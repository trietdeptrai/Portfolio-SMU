...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col md:flex-row overflow-hidden pt-16 md:pt-0">
      {/* Background Video Container (Empty for now) */}
      ...
      <motion.div 
        ...
        className="flex-1 relative z-10 flex flex-col justify-center p-8 md:p-16 lg:p-24 border-b md:border-b-0 md:border-r border-border/50 bg-background/50 backdrop-blur-sm"
      >
      ...
      <motion.div 
        ...
        className="flex-1 relative z-10 flex flex-col justify-center p-8 md:p-16 lg:p-24 bg-foreground/5 dark:bg-background/50 backdrop-blur-sm"
      >
        ...
        <p className="text-lg max-w-md text-muted-foreground font-mono text-sm">
